...
const AdminDash = () => {
  return (
    <>
      ...
      <Link to="/admin/createcategory" className="flex justify-center mx-auto mt-2 text-white bg-blue-600 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-600 rounded text-lg w-48">Create Category</Link>
      ...
      <Link to="/admin/assigncategory" className="flex justify-center mx-auto mt-2 text-white bg-blue-600 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-600 rounded text-lg w-48">Assign Category</Link>
