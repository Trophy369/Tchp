...
const AdminDash = () => {
  return (
    <>
      <h1>admin page</h1>
      <Link to="/admin/createproduct" className="flex justify-center mx-auto mt-2 text-white bg-blue-600 border-0 py-2 px-auto focus:outline-none hover:bg-indigo-600 rounded text-lg">Create Product</Link>
      ...
      <h4>Old Product Create Dont Use</h4>
      <Link to="/admin/addproduct" className="flex justify-center mx-auto mt-2 text-white bg-blue-600 border-0 py-2 px-auto focus:outline-none hover:bg-indigo-600 rounded text-lg">Add Product</Link>
