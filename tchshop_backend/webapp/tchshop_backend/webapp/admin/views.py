from flask import render_template, url_for, abort, redirect, request, flash, jsonify
from . import admin
from models.user import Role, User, Cart
from models.product import Product
from flask_login import login_required, current_user
from models.product import Product, Category, Review, Shipping
...
# add reviews
@login_required
@admin.route('/addreview', methods=['GET', 'POST'], strict_slashes=False)
@has_role('administrator')
def add_review():
    pass
