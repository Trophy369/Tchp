...
from models.product import Product, Category, Review, CartItem, Description, DescriptionImage, ProductImage, Shipping
...
def make_shell_context():
    ...
    return dict(db=db, BaseModel=BaseModel, Product=Product, Category=Category, Cart=Cart, CartItem=CartItem,
                ...
                Shipping=Shipping, Description=Description, DescriptionImage=DescriptionImage, ProductImage=ProductImage)
